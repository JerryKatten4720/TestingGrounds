...
public static class TileRegistry {
    ...
    static TileRegistry() {
        ...
        Register("Water", Color.FromRgb(21, 101, 192), Color.FromRgb(13, 71, 161), Color.FromRgb(8, 50, 130),
            isWalkable: false);
    ...
    public static void RegisterOrUpdate(string name, Color top, Color left, Color right,
        ...
        if (_defs.TryGetValue(name, out var existing)) {
            ...
            Register(name, top, left, right, isCustom, isWalkable);
        }
    }
    ...
    public static TileDefinition Get(string name) {
        return _defs.TryGetValue(name, out var d) ? d : _defs["Grass"];
    }
}